package org.math_dragon.model;

import static org.math_dragon.view.math.Function.FunctionType.ARCCOS;
import static org.math_dragon.view.math.Function.FunctionType.ARCSIN;
import static org.math_dragon.view.math.Function.FunctionType.ARCTAN;
import static org.math_dragon.view.math.Function.FunctionType.COS;
import static org.math_dragon.view.math.Function.FunctionType.COSH;
import static org.math_dragon.view.math.Function.FunctionType.LN;
import static org.math_dragon.view.math.Function.FunctionType.SIN;
import static org.math_dragon.view.math.Function.FunctionType.SINH;
import static org.math_dragon.view.math.Function.FunctionType.TAN;
...
import org.math_dragon.exceptions.ParseException;
import org.math_dragon.exceptions.TooBigValueException;
import org.math_dragon.view.math.Expression;
import org.math_dragon.view.math.Function;
import org.math_dragon.view.math.operation.binary.Add;
import org.math_dragon.view.math.operation.binary.Divide;
import org.math_dragon.view.math.operation.binary.Multiply;
import org.math_dragon.view.math.operation.binary.Power;
...
public final class ModelHelper
{
     ...
     *         Thrown when conversion is impossible.
     */
    static org.math_dragon.view.math.Symbol symbol(Symbol s)
    {
        org.math_dragon.view.math.Symbol symbol = new org.math_dragon.view.math.Symbol(1);
     ...
     *         Thrown when conversion is impossible.
     */
    static org.math_dragon.view.math.Symbol integer(IInteger i) throws ParseException
    {
        ...
        return new org.math_dragon.view.math.Symbol(i.longValue());
    }
    ...
    static Add complex(IComplex c) throws ParseException
    {
        ...
        org.math_dragon.view.math.Symbol imag = new org.math_dragon.view.math.Symbol(1);
        imag.setIPow(1);
        Expression multiplicand = toExpression(c.getIm());
        return new Add(real, new Multiply(multiplicand, imag));
    }

    /** Convert a numeric constant from Symja to {@link org.math_dragon.view.math.Symbol Symbol}
     * 
     * @param expr The numeric constant from Symja
     * @return A {@link org.math_dragon.view.math.Symbol Symbol} with the value of <tt>expr</tt> */
    private static Expression num(INum expr)
    {
        return new org.math_dragon.view.math.Symbol(expr.getRealPart());
    }

    /** Convert a numeric complex constant from Symja to {@link org.math_dragon.view.math.Expression Expression}
     * 
     * @param expr The numeric complex constant from Symja
     * @return A {@link org.math_dragon.view.math.Expression Expression} with the value of <tt>expr</tt> */
    private static Expression complexNum(IComplexNum expr)
    {
        org.math_dragon.view.math.Symbol re = new org.math_dragon.view.math.Symbol(expr.getRealPart());
        org.math_dragon.view.math.Symbol im = new org.math_dragon.view.math.Symbol(expr.getImaginaryPart());
        im.setIPow(1);
