package org.math_dragon.view.math.source.operation;

import static org.math_dragon.view.math.Expression.lineWidth;
...
public class Derivative extends Expression
{
    ...
    @Override
    public org.math_dragon.view.math.Expression createMathObject()
    { return new org.math_dragon.view.math.operation.binary.Derivative(null, Symbol.createVarSymbol('x')); }
    ...
    public void draw(Canvas canvas, int w, int h)
    {
        ...
        // Draw the text
        canvas.drawText("d", (w - emptyBox.width()) / 2 - textBox.width(), emptyBox.height() * 2 + org.math_dragon.view.math.Expression.lineWidth, paintOperator);
