...
public class BinaryLinear extends Expression
{
    ...
    public void draw(Canvas canvas, int w, int h)
    {
        ...
        paintOperator.setStrokeWidth(org.math_dragon.view.math.Expression.lineWidth);
        switch(type)
        {
            case ADD:
            case SUBTRACT:
            ...
            case MULTIPLY:
                ...
                canvas.drawCircle(centerX, centerY, org.math_dragon.view.math.Expression.lineWidth * 2, paintOperator);
            break;
        }
    }
}
