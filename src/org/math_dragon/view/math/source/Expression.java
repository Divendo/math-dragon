package org.math_dragon.view.math.source;
...
public abstract class Expression
{
    ...
    public abstract org.math_dragon.view.math.Expression createMathObject();
    ...
    protected void drawEmptyBox(Canvas canvas, Rect rect)
    {
        ...
        final int d = (int) Math.ceil(org.math_dragon.view.math.Expression.lineWidth / 2);
        copy.inset(d, d);
        
        // Draw the dashed rectangle
        paintEmptyBox.setStrokeWidth(org.math_dragon.view.math.Expression.lineWidth);
