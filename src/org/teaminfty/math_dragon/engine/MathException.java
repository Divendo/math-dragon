...
public class MathException extends Exception {
	...
	/**
     * Constructs a new mathematical exception with the specified detail message.
     ...
     * <tt>cause</tt>). This constructor is useful for exceptions that are little
     * more than wrappers for other throwables (for example, {@link
	 ...
	 * @param message The detailed human-readable message.
	 * @param cause Some evil demon that wants to crash our program.
	 */
